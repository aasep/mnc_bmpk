...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/google/google_css_p1.css?family=Oswald:400,300,700" rel="stylesheet" type="text/css" />
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <p class="copyright"> 2020
                    <a target="_blank" href="#"><?= constant("TITLE_APP");?>
...
<![endif]-->
       ...
       <script src="assets/pages/scripts/form-validation.min.js" type="text/javascript"></script>
        ...
        <!-- <script src="assets/pages/scripts/ui-session-timeout.min.js" type="text/javascript"></script> -->
        ...
        <script>
            ...
            $(document).ready(function()
            {
                 ...
                 $.sessionTimeout({
                    ...
                    redirUrl: 'logout.php?msg=auto',
                    logoutUrl: 'logout.php?msg=auto',
                    warnAfter: 5000, //warn after 15 Menit
                    redirAfter: 10000, //redirect after 20 second
