        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 coming-soon-header">
					...
					<img src="images/logo.png" alt="logo" style="height: 100px;" class="logo-default"/> 
 ...
 ?>   
            ...
            <div class="row">
                <div class="col-md-6 coming-soon-content">
                    <h3 class="bold"><strong>Gagal Koneksi Database </strong></h3>
                    <h3 class="bold"><strong>atau Sedang Maintenance..  !</strong> </h3>
                    <p>  </p>
                    <br>
                    <a href="login"><button class="btn blue "><strong> RE LOGIN </strong>  </button></a>
...
<?php 
 ...
 ?> 
            <!--/end row-->
            <div class="row">
                <div class="col-md-12 coming-soon-footer"> 2019  PT MNC Bank Internasional  , Tbk. </div>
            </div>
        </div>
        <!--[if lt IE 9]>
