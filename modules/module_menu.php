                                ...
                                <div class="form-body">
                                    ...
                                    <div class="alert alert-success display-hide">
                                        <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                                    ...
                                                    <?php
                                                        $query_group="select * from menu where parentmenu='0' ";
...
<!--  end delete modal -->
                    ...
                    <div class="page-content-container">
                        ...
                        <div class="portlet-body form">
                            ...
                            $query =" select * from menu where parentmenu='0' order by idmenu asc ";
                            $RS  = $db->Execute($query);
...
id-parentmenu='".$RS->fields['parentmenu']."'  id-address='".trim($RS->fields['address'])."' id-idmenu='".$RS->fields['idmenu']."' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
                            ...
                            $SQL2 ="select * from menu where parentmenu='".$RS->fields['idmenu']."' AND parentmenu <> '0'  order by idmenu asc ";
                            $RS2  = $db->Execute($SQL2);
                            ...
                            id-parentmenu='".$RS2->fields['parentmenu']."'  id-address='".trim($RS2->fields['address'])."' id-idmenu='".$RS2->fields['idmenu']."' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
                                            ...
                                            $SQL_cek ="select count(idmenu) as jml_menu from menu where parentmenu='".$RS2->fields['idmenu']."' AND parentmenu <> '0' ";
                                            ...
                                            if($RS_cek->fields['jml_menu'] >=1){
                                                ...
                                                $SQL3 ="select * from menu where parentmenu='".$RS2->fields['idmenu']."' AND parentmenu <> '0' order by idmenu asc ";
                                                $RS3  = $db->Execute($SQL3);
                                                //echo $SQL3;
                                                $submenu2=1;
                                                while(!$RS3->EOF){
