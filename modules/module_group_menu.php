                            ...
                            <form action="<?php echo "$page"; ?>" id="form_sample_3" class="form-horizontal" method="POST">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 bold">Role User <span class="required">
                                        * </span>
                                        </label>
                                        <div class="col-md-4">
           ...
           <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    <div class="portlet light grey-steel bordered">
                        ...
                        <form name="form1" method="post" action="" > 
                            ...
                            $SQL="select * from menu where parentmenu = '0' ";
                            $RS2  = $db->Execute($SQL);
                                ...
                                while(!$RS2->EOF){
                                    ...
                                    echo "<td></td></tr>";
                                        ...
                                        $SQL3="select * from menu where parentmenu = '".$RS2->fields['idmenu']."' ";
                                        $RS3  = $db->Execute($SQL3);
                                        $no_sub=1;
                                        while(!$RS3->EOF){
                                            ...
                                            $SQL_CEK    = " select count(*) as jml_row from menu where parentmenu = '".$RS3->fields['idmenu']."' ";
                                            ...
                                            if ($is_child >0){
                                                    ...
                                                    $SQL_child=" select * from menu where parentmenu = '".$RS3->fields['idmenu']."' ";
                                                    ...
                                                    while (!$RS_child->EOF) {
                                                        ...
                                                        $qCek       ="  select count(*) as jml_child from menu where parentmenu = '".$RS_child->fields['idmenu']."' ";
                                                        $rCek       =   $db->Execute($qCek);
                                                        $jml_child  =   $rCek->fields['jml_child'];

                                                        if ($jml_child >0){
                                                        // jika ada loop anak dibawahnya
                                                            $SQL5       ="  select * from menu where parentmenu = '".$RS_child->fields['idmenu']."' ";
                                                            $RS5        =   $db->Execute($SQL5);
                                                            //$jml_child    =   $RS5->fields['jml_child'];
                                                                ...
                                                                while(!$RS5->EOF) {
                                                                    ...
                                                                    $SQL4 =" SELECT groupmenuid FROM group_menu  WHERE groupid='$id_group' AND idmenu='".$RS5->fields['idmenu']."' ";
                                                                    $RS4  = $db->Execute($SQL4);
                                                                    $found= $RS4->RowCount();
                                                ...
                                                $no_sub++;  
                                                    ...
                                                    // cek group menu 
                                                    $SQL4=" SELECT groupmenuid FROM group_menu  WHERE groupid='$id_group' AND idmenu='".$RS3->fields['idmenu']."' ";
                                                    $RS4  = $db->Execute($SQL4);
                                                    $found= $RS4->RowCount();
...
// Check if delete button active, start this
    if(isset($_POST['hidup'])){
        for($i=0;$i<count($_POST['checkbox']);$i++){
                ...
                $query_cek=" SELECT groupmenuid FROM group_menu  WHERE groupid='$id_group' AND idmenu='$del_id' ";
                //echo $query_cek."</br>";
                ...
                {  
                    $result_priv=1;
                        ...
                        //insert
                        $sql_priv=" INSERT INTO group_menu (groupid,idmenu,adddt,addby) values ('$id_group','$del_id',current_timestamp,'$_SESSION[USERNAME]') ";
                        //echo $sql_priv."</br>";
    ...
    if(isset($_POST['mati'])){
        for($i=0;$i<count($_POST['checkbox']);$i++){
                ...
                if ($found_priv >=1){  //delete
                        $sql_priv=" DELETE FROM group_menu where groupid='$id_group' AND idmenu='$del_id' ";
                        //echo $query_cek."</br>";
                         //$result_priv = odbc_exec($connection,$sql_priv);
                         $RS2  = $db->Execute($sql_priv);
