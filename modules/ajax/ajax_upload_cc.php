...
//echo $highestRow_cek;
                   ...
                   // if (count($data1_cek)>=4){
                        $sql_truncate   = " truncate table bmpk_bank_creditcard ";
                 ...
                 //   }
                    ...
                    foreach ($data1_cek as $row => $value) { 
                                  ...
                                  $keterangan        = preg_replace('/[^\p{L}\p{N}\s]/u', '', $keterangan);
                                  $keterangan        = preg_replace('/[^A-Za-z0-9\-]/', '', $keterangan);
                                ...
                                if( ($value[0] != "")){
                                    ...
                                    $sql_insert =" insert into bmpk_bank_creditcard (nama_debitur,pihak_terkait,jenis_fasilitas,sifat_fasilitas, ";
