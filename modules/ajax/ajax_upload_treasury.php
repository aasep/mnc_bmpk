...
//echo $highestRow_cek;
                   ...
                   // if (count($data1_cek)>=4){
                        $sql_truncate   = " truncate table bmpk_bank_treasury ";
                  ...
                  //  }
                    ...
                    foreach ($data1_cek as $row => $value) { 
                                ...
                                if( ($value[0] != "")){
                                    ...
                                    $sql_insert =" insert into bmpk_bank_treasury (nama_debitur,pihak_terkait,jenis_fasilitas,sifat_fasilitas, ";
