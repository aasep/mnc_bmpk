...
$(document).ready( function() {
    ...
    $('#list_pttbkp').dataTable({
        //"sSearch": true,
        "bFilter": true,
        "bInfo": true,      
        "processing": true,
        "serverSide": true,
        "sAjaxSource": "../bmpk.id/modules/server_side/server_processing_pttng.php?act1=<?php echo "$act1&srcby=$srcby&srckey=$srckey&module=$module&pm=$pm";?>",
        "iDisplayLength": 10,
                    ...
                    <!-- BEGIN SIDEBAR CONTENT LAYOUT -->
                     <div class="page-content-container" id="pagelist">
                        ...
                        <div class="portlet-body form">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="list_pttbkp" width="100%">
                            <thead>
                            <tr>
                                <th width="5%"><b>No</b></th>
                                <th width="5%"><b>CIF</b></th>
                                <th width="15%"><b>Acc.Nummber</b></th>
                                <th width="25%"><b>Debitur</b></th>
                                ...
                                <th width="10%"><b>Jenis</b></th>
                                <th width="10%"><b>BIHUB</b></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<!--                             <table class="table table-striped table-bordered table-hover" id="sample_3" width="100%">
                            ...
                            <?php
                            $i=1;
                            $query =" select * from pihak_tdk_terkait_ng  order by cpgdes   asc ";
                            //echo $query;
                            ...
                            echo "<td width='20%' style='font-size:12px' align='right'><a href='#' class='btn default' disabled> <b>".number_format($RS2->fields['cpplaf'],2,".",",")."</b></a></td>";
                            echo "<td width='20%' style='font-size:12px' align='right'><a href='#' class='btn default' disabled> <b>".number_format($RS2->fields['cpouts'],2,".",",")."</b></a></td>";
                            echo "<td width='20%' style='font-size:12px' align='right'><a href='#' class='btn default' disabled> <b>".number_format($RS2->fields['ccolateral'],2,".",",")."</b></a></td>";
