                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo "modules/actions_master.php?module=$module&pm=$pm&act=insert_reserve_bmpk"; ?>" id="form_sample_3" class="form-horizontal"  method="POST" >
                                <div class="form-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo "modules/actions_master.php?module=$module&pm=$pm&act=delete_reserve_bmpk"; ?>" class="form-horizontal" method="POST" class="form-horizontal">
                                <div class="form-body">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                    <div class="alert alert-success display-hide">
...
$(document).ready(function() {
    ...
    $('.detailDelete').click(function() {
        var id_reserve = $(this).attr('id_reserve');
        var divid = $(this).attr('id-id_div');
        var nama_divisi = $(this).attr('id-nama_divisi');
        var nominal = $(this).attr('id_nominal');
          //alert(id_user);
            $("#list-user").empty();
            $("#list-user").append( 
                '<tr>'+
                '<td>'+'<div class="alert alert-danger"><h5> Yakin Anda Akan Mendelete Reserve '+'<strong>' + nama_divisi +'</strong> sebesar ' + nominal +' !  </h5></div>'+
