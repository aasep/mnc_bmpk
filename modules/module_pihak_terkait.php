                    ...
                    <!-- BEGIN SIDEBAR CONTENT LAYOUT -->
                     <div class="page-content-container" id="pagelist">
                        ...
                        <div class="portlet-body form">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample" width="100%" >
                            <thead>
                            <tr>
                                <th width="5%"><b>No</b></th>
                                <th width="5%"><b>CIF</b></th>
                                <th width="15%"><b>Acc.Number</b></th>
                                <th width="10%"><b>Debitur</b></th>
                                <th width="5%"><b>BR#</b></th>
                                <th width="10%"><b>Group</b></th>
                                <th width="10%"><b>Plafon</b></th>
                                <th width="10%"><b>Outstanding</b></th>
                                <th width="10%"><b>Cash Collateral</b></th>
                                <th width="10%"><b>Product</b></th>
                                <th width="5%"><b>Jenis</b></th>
                                <th width="5%"><b>BIHUB</b></th>
                                <th width="5%"><b>KET</b></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            $query =" select a.cfcif,a.acctno,a.cfsnme,a.cfbrnn,a.cpgdes,a.cpplaf,a.cpouts,a.type,a.jenis,a.bihub1,b.prod_type  from pihak_terkait a ";
                            $query.=" left join mapp_product b on replace(b.product,' ','')=replace(a.type,' ','') order by a.cpgdes asc ";
                            //echo $query;
                            ...
                            echo "<td width='20%' style='font-size:12px' align='right'><a href='#' class='btn default' disabled> <b>".number_format($RS2->fields['cpplaf']
                                *$nominalValas,2,".",",")."</b></a></td>";
                            ...
                            echo "<td width='5%' style='font-size:12px'><b> ".$RS2->fields['bihub1']." </b></td>";
                             echo "<td width='5%' style='font-size:12px'><b> ".$RS2->fields['prod_type']." </b></td>";
