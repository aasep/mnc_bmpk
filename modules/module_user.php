...
<div class="page-content">
 ...
 <?php
    ...
    if (isset($_GET['message']) && ($_GET['message']=="errorx")){
        echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>$_GET[varx] ...!</strong> </div>";
    }
                                    ...
                                    <div class="alert alert-success display-hide">
                                        <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label bold">Username (NIK/NIP)
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4 bold">Role User
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-8">
