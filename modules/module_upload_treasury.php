...
<!-- INPUT BIASA -->
                        <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                        ...
                                        <a href="data/download/format/format_treasury.xlsx" class="btn green pull-right" download=""> <i class="fa fa-download"></i> <b>Download Format Excel </b> </a>    
                                </div>
...
<div id="targetLayer"> </div>
                    ...
                    <div class="portlet light grey-steel bordered " id="mytable" style="display:none">
                        ...
                        <div class="portlet-body form">
                            ...
                            <?php
                            $i=1;
                            $query =" select * from bmpk_bank_treasury order by id_bg asc ";
                            //echo $query;
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                                <form action="<?php echo "modules/actions_master.php?module=$module&pm=$pm&act=approve_treasury1"; ?>" class="form-horizontal" method="POST" class="form-horizontal">
                                <div class="form-body">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                    <div class="alert alert-success display-hide">
                                        <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                                        ...
                                                        <div  class="alert alert-info" id="list-user2">
                                                           ...
                                                           <b> Apakah Anda Yakin Akan Melakukan Approve Treasury ! </b>
...
$(document).ready(function (e) {
    $("#form_sample_7").on('submit',(function(e) {
        ...
        //$("#mytable").empty();
        $.ajax({
            url: "modules/ajax/ajax_upload_treasury.php",
            type: "POST",
