...
/*if (isset($_GET['act1']) ) {
    ...
    $sWhere = " WHERE a.username='".getUsername()."' ";
    ...
    if ( $_GET['sSearch'] != "" )
    {
        ...
        $sWhere .= ") and a.username='".getUsername()."' ";
...
*/
    ...
    $sQuery  = " select a.before_img,a.after_img,a.rek_id,a.username,a.no_rek_medis,a.nama_pasien,a.sex,a.age,a.divid,b.divname,c.dosen_name,a.adddt,a.id_dosen,a.diagnosis from rekam_medik a ";
    ...
    while(!$rResult->EOF)
    {
        ...
        for ( $i=0 ; $i<count($aColumns) ; $i++ )
        {
            ...
            {               
                ...
                $nama_action="<a class='detailEdit' data-toggle='modal' data-target='#basic2' href='#' id-username='".trim($rResult->fields['username'])."'  id-rek_id='".$rResult->fields['rek_id']."' id-no_rek_medis='".$rResult->fields['no_rek_medis']."' id-nama_pasien='".$rResult->fields['nama_pasien']."' id-age='".$rResult->fields['age']."' id-diagnosis='".$rResult->fields['diagnosis']."' id-divid='".$rResult->fields['divid']."' id-id_dosen='".$rResult->fields['id_dosen']."' id-sex='".$rResult->fields['sex']."' id-before_img='".$rResult->fields['before_img']."' id-after_img='".$rResult->fields['after_img']."'><button class='btn red'> <b> Edit </b> <i class='fa fa-get-pocket'></i> </button></a>";  
               //$nama_action="123";  b
               $row[] = $nama_action; 
            }
