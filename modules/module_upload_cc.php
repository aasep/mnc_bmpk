...
<div id="targetLayer"> </div>
                    ...
                    <div class="portlet light grey-steel bordered " id="mytable" style="display:none">
                        ...
                        <div class="portlet-body form">
                            ...
                            <?php
                            $i=1;
                            $query =" select * from bmpk_bank_creditcard order by id_bg asc ";
                            //echo $query;
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo "modules/actions_master.php?module=$module&pm=$pm&act=approve_creditcard"; ?>" class="form-horizontal" method="POST" class="form-horizontal">
                                <div class="form-body">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                    <div class="alert alert-success display-hide">
                                        <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                                        ...
                                                        <div  class="alert alert-info" id="list-user2">
                                                           ...
                                                           <b> Apakah Anda Yakin Akan Melakukan Approve CreditCard ! </b>
